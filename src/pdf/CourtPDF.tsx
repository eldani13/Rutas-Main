  ...
  return (
    <Document pageMode="fullScreen">
      <Page size={"A4"} orientation="portrait" wrap={true} style={styles.page}>
        ...
        <View style={styles.table}>
          <View style={styles.column}>
            ...
            {corte.productosVendidos.map((product: any, index: number) => (
              <Text style={styles.text} key={"textSale-products-" + index}>
                {}
              </Text>
            ))}
          </View>
          <View style={styles.column}>
            ...
            {corte.productosVendidos.map((product: any, index: number) => (
              <Text style={styles.text} key={"textSale-cantidad-" + index}>
                {}
              </Text>
            ))}
          </View>
          <View style={styles.column}>
            ...
            {corte.productosVendidos.map((product: any, index: number) => (
              <Text style={styles.text} key={"textSale-price-" + index}>
                {}
              </Text>
            ))}
          </View>
        ...
        <View style={styles.table}>
          <View style={styles.column}>
            ...
            {corte.productosNoVendidos.map((product: any, index: number) => (
              <Text style={styles.text} key={"textNoSale-products-" + index}>
                {}
              </Text>
            ))}
          </View>
          <View style={styles.column}>
            <Text style={styles.tableHeader}>Cantidad</Text>
            {corte.productosNoVendidos.map((product: any, index: number) => (
              <Text style={styles.text} key={"textNoSale-cantidad-" + index}>
                {}
              </Text>
            ))}
          </View>
          <View style={styles.column}>
            <Text style={styles.tableHeader}>Precio</Text>
            {corte.productosNoVendidos.map((product: any, index: number) => (
              <Text style={styles.text} key={"textNoSale-price-" + index}>
                {}
              </Text>
            ))}
          </View>
        ...
        <Text style={styles.subtitle}>Devoluciones</Text>
        <View style={styles.table}>
          <View style={styles.column}>
            <Text style={styles.tableHeader}>Productos</Text>
            {corte.productosNoVendidos.map((product: any, index: number) => (
