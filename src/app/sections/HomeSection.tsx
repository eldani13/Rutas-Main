        ...
        <>
            ...
            <div className="text-[#000] flex flex-col items-center gap-20">
                ...
                <div className="flex flex-col ">
                    <div className="grid px-4" style={{ gridTemplateColumns: "1fr 1fr", gridTemplateRows: "1fr 1fr" }}>

                        {/* Administrador */}
                        <div className="cursor-pointer h-36 w-80 flex justify-center items-center gap-5  ">
                        ...
                        {/* Empleados */}
                        <div className="group cursor-pointer h-36 w-96 flex justify-between items-center  gap-5">
