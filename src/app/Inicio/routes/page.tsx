...
export default function Route() {
  ...
  console.log(
    employees?.message.find((u) => u._id === routes?.message[0].empleado)
  );
  console.log(
    employees?.message.find((u) => u._id === routes?.message[1].empleado)
  );
  console.log(
    vehicles &&
      vehicles.message.find((u) => u._id === routes?.message[0].vehicle)?.marca
  );
  console.log(
    vehicles &&
      vehicles.message.find((u) => u._id === routes?.message[1].vehicle)?.marca
  );
