                ...
                <div className="flex flex-col ">
                    <div className="grid px-4 grid-cols-1 lg:grid-cols-2 justify-center items-center gap-x-10 gap-y-2" >
                        ...
                        <Link href="/Inicio/employees">
                            <ViewOnlyGetComponent title="Empleados" description={`Cuenta actualmente con ${countEmployees} Empleados`} >
                        ...
                        <Link href="/Inicio/routes">
                            <ViewOnlyGetComponent title="Rutas" description={`Cuentas con ${countRoute} Rutas`}>
                        ...
                        <Link href="/Inicio/product">
                            <ViewOnlyGetComponent title="Productos" description={`Actualmente tienes ${countProducts} productos registrados`}>
