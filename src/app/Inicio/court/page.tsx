...
import { corteResponse } from '@/temp/TempCourtResponse'

export default function Court() {
  const [currentCourt, setCurrentCourt] = useState(corteResponse)
  ...
  return (
    <>
      <div className='flex flex-col items-start border-r-2 border-[#bbbcbc] pt-14 px-4 h-[100%] justify-between  overflow-hidden max-h-[100vh]'>
        <div className='flex flex-col items-start justify-center'>
          ...
          <div className='grid grid-cols-2'>
            ...
            <span className='mr-[-40px]'>Ruta {currentCourt.ruta}</span>
          </div>
      ...
      <div
        ...
        {/*  Show PDF viewer */}
        {showPDF ? (
          <PDFViewer style={{ width: '100%', height: '100vh' }} showToolbar>
          ...
          <div
            ...
            style={{
              ...
              gridTemplateAreas:
                " 'productSold productSold summary' 'productNotSold productNotSold summary' ",
            }}>
            {/* Primer div */}
            <div
              className='flex text-black px-3 '
            ...
            {/* Segundo div */}
            <div
              className='flex flex-col text-black px-3 justify-between pb-5'
              ...
              <div>
                <div className='grid grid-cols-2 w-full py-5'>
                  ...
                  <div className='flex justify-between px-10'>
                    <p>$</p>
                    <p className='relative flex-1 text-right'>
              ...
              <div
                className='w-full flex flex-col gap-5  rounded-xl text-center py-5'
