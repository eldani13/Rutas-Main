...
export default function Employees() {
    ...
    const agregarDato = () => {
        if (modoEdicion) {
            setDatosNuevos((prevDatos) =>
                prevDatos.map((dato) =>
                    dato._id === usuarioEditando._id ? { ...dato, ...usuarioEditando } : dato
                )
            );
    ...
    const guardarDato = () => {
        if (modoEdicion) {
            setDatosNuevos((prevDatos) =>
                prevDatos.map((dato) =>
                    dato._id === usuarioSeleccionado._id ? { ...dato, ...usuarioSeleccionado } : dato
                )
            );
            setModoEdicion(false);
        } else {
    ...
    const [usuarioSeleccionado, setUsuarioSeleccionado] = useState<Partial<Message>>({});
        ...
        <>
            <div className="flex flex-col items-start border-r-2 border-[#bbbcbc] pt-14 px-4 h-[100%] justify-between">
                ...
                <div className="pb-10 flex flex-col space-y-10 items-center">
                    ...
                    <button onClick={agregarDato} className="bg-[#ececec] text-black px-2 py-2 mb-2 rounded-[50px] h-14 w-52 flex items-center justify-between font-bold">
                    ...
                    <button onClick={editarUsuario} className="bg-[#ececec] text-black px-2 py-2 mb-2 rounded-[50px] h-14 w-52 flex items-center justify-between font-bold">
            ...
            <div className="max-h-[100vh] h-full pt-14 flex flex-col overflow-y-auto p-5">
                ...
                <table className="w-full table-auto">
                    ...
                    <tbody>
                        ...
                        >
                            <h2 className="text-black p-10 flex justify-center text-4xl">Ingrese nuevo usuario</h2>
                            <div>
                                ...
                                <form className="space-x-2">
                                    ...
                                    <input className="text-black border"
                                        type="text"
                                        value={nuevoDato._id || ""}
                                        onChange={(e) => setNuevoDato({ ...nuevoDato, _id: e.target.value })}
                                    />
                                    ...
                                    <input className="text-black border"
                                        ...
                                        onChange={(e) => setNuevoDato({ ...nuevoDato, user: e.target.value })}
                                    />
                                    ...
                                    <input className="text-black border"
                                        ...
                                        onChange={(e) => setNuevoDato({ ...nuevoDato, username: e.target.value })}
                                    />
                                    ...
                                    <input className="text-black border"
                                        ...
                                        onChange={(e) => setNuevoDato({ ...nuevoDato, lastnames: e.target.value })}
                                    />
                                    ...
                                    <input className="text-black border"
                                        ...
                                        onChange={(e) => setNuevoDato({ ...nuevoDato, role: e.target.value })}
                                    />
                                    ...
                                    <input className="text-black border"
                                        ...
                                        onChange={(e) => setNuevoDato({ ...nuevoDato, password: e.target.value })}
                                    />
