          ...
          <form onSubmit={handleLogin} className="p-12 md:p-24" method="post">
            ...
            <div className="flex items-center text-lg mb-6 md:mb-8">
              ...
              <input id="email" inputMode='url' autoComplete="username" autoCapitalize="off" autoCorrect="off" dir="auto"
                type="text" ref={inputUsername} name='username' className="bg-gray-200 rounded-full text-black pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Username" />
            </div>
            ...
            <div className="flex items-center text-lg mb-6 md:mb-8 relative">
              ...
              <input type={viewPassword ? "text" : "password"} ref={inputPassword} name='role' className="bg-gray-200 rounded-full text-black pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Password" />
