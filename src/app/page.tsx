          ...
          >
            ...
            <div className="flex justify-center p-4">
              <span className="text-black">
                Si olvido su contraseña, comuniquese con el administrador.
              </span>
            </div>

            <button className="bg-gradient-to-b rounded-full from-gray-700 to-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full">
              Login
            </button>
          </form>
        </div>
