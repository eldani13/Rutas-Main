...
export default function HomePage() {
  ...
  const handleLogin = async (e: FormEvent) => {
    if (loadPetition) return;

    setLoadPetition(true);
    e.preventDefault();
    try {
      const response = await fetch(`${processEnv.back}createtoken`, {
        method: "POST",
      ...
      setErrorMessage(
        "Upss, error inesperado, por favor contacte con el desarrollador"
      );
    }
  };
  return (
          ...
          <form onSubmit={handleLogin} className="p-12 md:p-24" method="post">
            <div className="flex items-center text-lg mb-6 md:mb-8">
              ...
              >
                ...
                <path
                  fill="black"
                  d="M15 30v3a1 1 0 0 0 1 1h17a1 1 0 0 0 1-1V23a1 1 0 0 0-1-1h-7v-1.47a1 1 0 0 0-2 0V22h-2v-3.58a32.12 32.12 0 0 0-5.14-.42a26 26 0 0 0-11 2.39a3.28 3.28 0 0 0-1.88 3V30Zm17 2H17v-8h7v.42a1 1 0 0 0 2 0V24h6Z"
                />
              </svg>
              <select
                onChange={(e) => {
                ...
                name=""
                id=""
                className="bg-gray-200 rounded-full text-black pl-12 py-2 md:py-4 focus:outline-none w-full"
              >
            ...
            {!loadPetition ? (
              <button
                type="submit"
                className="bg-gradient-to-b rounded-full from-gray-700 to-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full"
              >
                Login
              </button>
            ) : (
